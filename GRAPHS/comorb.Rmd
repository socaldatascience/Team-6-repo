...
=======
setwd("C:/Users/lizvi/Cal State Fullerton/Jaynes, Jessica - CSUF CHOC Summer 2022 Research/Group2")
>>>>>>> ee6935bcafa22e233e0337cbf764b8bd35821ccf
...
lda_comorb <- all_comorb[, c(names(lasso_coef[lasso_coef != 0])[-1], "COVIDseverity")]
...
lda_predict <- predict(lda_comorb, newdata = test_lda.df )
```
